...
* Ver      负责人        变更内容            变更日期
* ──────────────────────────────────────────────────────────────
* V1.0     张亮          初版                2018-09-27 10:24:38 
*
...
namespace Model
{
    public class T_BF_EqmInfo
    {
        ...
        public string F_EqmTag { get; set; }
        ...
        [SugarColumn(IsNullable = true)]
        public short F_EqmTagType { get; set; }
        [SugarColumn(IsNullable = false)]
        public int F_EqmPort { get; set; }
        [SugarColumn(IsNullable = true)]
        public short F_ProductLine { get; set; }
        [SugarColumn(IsNullable = true)]
        public int F_EqmReadStart { get; set; }
        [SugarColumn(IsNullable = true)]
        public int F_EqmReadLen { get; set; }
        [SugarColumn(IsNullable = true)]
        public short F_PlcType { get; set; }
        [SugarColumn(IsNullable = true)]
        public short F_Used { get; set; }
    }
}
