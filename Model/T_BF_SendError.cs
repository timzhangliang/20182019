...
* Ver      负责人        变更内容            变更日期
* ──────────────────────────────────────────────────────────────
* V1.0     张亮          初版                2018-09-27 12:19:58 
*
...
namespace Model
{
    public class T_BF_SendError
    {
        ...
        public DateTime? F_ErrorTime { get; set; }
        [SugarColumn(IsNullable = true)]
        public short F_ProductLine { get; set; }
        [SugarColumn(Length = 20, IsNullable = true)]
        public string F_SendIP { get; set; }
        [SugarColumn(Length = 30, IsNullable = true)]
        public string F_SendTag { get; set; }
